...
One BAM file per sample. The BAM files should be sorted by genomic coordinate (e.g. the default STAR output) and should be mapped using the same gene annotations as will be used for phenotype extraction.
